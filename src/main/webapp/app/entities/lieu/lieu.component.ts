...
export class LieuComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.lieuService
      ...
      .subscribe(
        (res: HttpResponse<ILieu[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLieus(): void {
    this.eventSubscriber = this.eventManager.subscribe('lieuListModification', () => this.loadPage());
  }
