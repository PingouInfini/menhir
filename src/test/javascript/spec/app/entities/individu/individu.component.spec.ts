...
import { IndividuComponent } from 'app/entities/individu/individu.component';
...
describe('Component Tests', () => {
  describe('Individu Management Component', () => {
    let comp: IndividuComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IndividuComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.individus && comp.individus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
